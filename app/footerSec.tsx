...
export const FooterSec = () => {
  return (
    <footer className="bg-white">
      <div className="px-16 py-16 mx-auto bg-green-300 max-w-screen sm:px-6 lg:px-28">
        <div className="lg:flex lg:items-start lg:gap-8">
          <div className="text-teal-600">
            <Image src={Logo} alt="ARIA" width={200} />
          </div>
          ...
          <div className="grid grid-cols-2 gap-8 mt-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
            ...
            <ul className="flex justify-start col-span-2 gap-6 lg:col-span-5 lg:justify-end">
              ...
              <li>
                <a
                  href="https://www.instagram.com/hernanidomingo"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
              ...
              <li>
                <a
                  href="https://www.x.com/domingo_hernani"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
              ...
              <li>
                <a
                  href="https://github.com/domingohernani"
                  rel="noreferrer"
                  target="_blank"
                  className="text-gray-700 transition hover:opacity-75"
                >
