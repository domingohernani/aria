      ...
      <div className="max-w-screen-xl px-4 py-8 mx-auto sm:py-16 lg:px-6">
        <div className="max-w-screen-lg mx-auto mb-8 text-center lg:mb-16">
          ...
          <p className="text-gray-500 sm:text-xl dark:text-gray-400">
            ...
            Augmented Reality Web Application! 🛋️ Offer customers an immersive
            experience, letting them visualize products in their space before
            purchase.
          </p>
        </div>
        <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-green-400">
              AR Showroom Creation
            </h3>
            <p className="text-gray-400 dark:text-gray-400">
              Design, visualize, share. Craft virtual showrooms effortlessly.
              Collaborate seamlessly and transform your space with AR.
            </p>
          </div>
          <div>
            <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Instantly create stunning 3D models. Bring your vision to life
              effortlessly with our powerful feature.
            </p>
          </div>
          <div>
            <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Tailor your experience. Personalize furniture to fit your style
              perfectly. Create your dream space effortlessly.
            </p>
          </div>
          <div>
            <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Unlock business potential. Gain valuable insights into customer
              behavior and trends. Drive success with actionable analytics.
            </p>
          </div>
          <div>
            <div className="flex items-center justify-center w-10 h-10 mb-4 rounded-full bg-primary-100 lg:h-12 lg:w-12 dark:bg-primary-900">
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Seamless integration, endless possibilities. Connect effortlessly
              with leading e-commerce platforms. Expand your reach with our
              integrated solution!
            </p>
          </div>
        </div>
